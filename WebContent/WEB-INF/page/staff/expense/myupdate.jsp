...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${ctx}/staff/expense/myupdate" enctype="multipart/form-data">
       <input type="hidden" name="id" id="id" value="${expense.date }" >   <!-- 不知道干嘛的 -->
        ...
        <%--   <div class="layui-form-item" > 
          ...
          <div class="layui-form-item">
              <label for="phone" class="layui-form-label">
                  <span class="x-red">*</span>上传报销单
              </label>
              <div class="layui-input-inline">
                  <input type="file" id="file" name="file"  required="" lay-verify="required"
                  autocomplete="off" value="${expense.picture }">
              </div>
          </div>   

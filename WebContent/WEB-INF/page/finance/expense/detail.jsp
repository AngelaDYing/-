...
<html>
  ...
  <body>
    ...
    <div class="x-body">
        <form class="layui-form" method="GET" id="detail"  action="${ctx}/finance/expense/detail"  enctype="multipart/form-data">
        <input type="hidden" name=date id="date" value="${expense.date }" >   
        <input type="hidden" name=id id="" value="${expense.id }" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="item" name="item"  required="" lay-verify="required"
          ...
          <div class="layui-form-item layui-form-text">
               ...
               <div class="layui-input-block">
                   <textarea  id="detail" name="detail" class="layui-textarea">${expense.detail }</textarea>
               </div>
            </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                   <img src="/imgUrl/${expense.picture}" width="200px" height="250px">
              </div>
          </div>   
        </form>
        <form class="layui-form" method="GET" id="myupdate"  action="${ctx}/finance/expense/myupdate" >
        <input type="hidden" name=date id="date" value="${expense.date }" >   
        <input type="hidden" name=id id="" value="${expense.id }" >
          
		 <div class="layui-form-item layui-form-text">
               <label for="desc" class="layui-form-label">
                   <span class="x-red">*</span> 审批结果
               </label>
               <div class="layui-input-inline">
        ...
        form.on('submit(add)', function(data){ 
          ...
          //发异步，把数据提交给php 
            layer.alert("审批成功", {icon: 6},function () { 
          	document.getElementById('myupdate').submit(); 
                // 获得frame索引 

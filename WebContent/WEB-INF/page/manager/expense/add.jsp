...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${ctx}/manager/expense/add"  enctype="multipart/form-data">
        <input type="hidden" name="id" id="id" value="${expense.date }" >   
